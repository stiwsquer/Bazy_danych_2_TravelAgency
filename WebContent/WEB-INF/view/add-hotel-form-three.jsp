...
<body>
	...
	<div id = "wrapper">
		<div id="header">
			<h2>Travel Agency - Select Company for new Hotel</h2>
		</div>
	</div>
		...
		<div id="content">
			...
			<table>
				...
				<c:forEach var="tempCompany" items="${companies}">
					...
					<c:url var="selectLink" value="/user/processAddHotelFormThree">
			...
			<p> 
				<a href="${pageContext.request.contextPath}/user/addHotelFormOne">Back to start</a>
			</p>
		</div>
	</div>
