...
<body>
	...
	<div id = "wrapper">
		<div id="header">
			<h2>Travel Agency - Select The Start Point of The Transport</h2>
		</div>
	</div>
		...
		<div id="content">
			...
			<table>
				...
				<c:forEach var="tempCity" items="${cities}">
					...
					<c:url var="selectLink" value="/user/processAddTransportFormTwo">
			...
			<p> 
				<a href="${pageContext.request.contextPath}/user/addTransportFormOne">Back</a>
			</p>
		</div>
	</div>
