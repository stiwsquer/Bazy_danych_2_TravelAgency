...
<body>
	...
	<div id = "wrapper">
		<div id="header">
			<h2>Travel Agency - Select City</h2>
		</div>
	</div>
		...
		<div id="content">
			...
			<table>
				...
				<c:forEach var="tempCity" items="${cities}">
					...
					<c:url var="selectLink" value="/user/processAddCompanyFormTwo">
			...
			<p> 
				<a href="${pageContext.request.contextPath}/user/addCompanyFormOne">Back</a>
			</p>
		</div>
	</div>
